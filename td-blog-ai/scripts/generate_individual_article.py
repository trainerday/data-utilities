...
class IndividualArticleGenerator:
    ...
    def create_individual_article(self, article_info):
...
def parse_features_markdown():
    ...
    try:
        ...
        # Find the table content between the header row and any subsequent section
        lines = content.split('\n')
        table_started = False
...
def main():
    ...
    try:
        result = generator.create_individual_article(selected_article)
